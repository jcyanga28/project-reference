...
<div class="row">
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => array('area.update', $area->id), 'method' => 'PUT', 'class' => 'bs-component')) }}
		<div class="form-group @if ($errors->has('area_number')) has-error @endif">
			{{ Form::label('area_no_desc', 'Area Number') }}
			{{ Form::text('area_number', $area->area_no, array('class' => 'form-control', 'placeholder' => 'Area Number', 'id' => 'area_input')) }}
		...
		<div class="form-group @if ($errors->has('area_place')) has-error @endif">
			...
			{{ Form::text('area_place', strtoupper($area->area_place), array('class' => 'form-control', 'placeholder' => 'Area Place', 'id' => 'area_input')) }}
