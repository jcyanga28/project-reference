...
<div class="row">
	...
	@if(isset($project_via_developer))
		@if(count($project_via_developer)>0)
		{{ Form::open(array('route' => 'generate.projectsviadevelopers.report', 'method' => 'POST','class' => 'bs-component')) }}
	...
	<table id="tbl_form_design" class="table table-striped">
		...
		<tbody>
			@if(isset($project_via_developer))
				@if(count($project_via_developer) > 0)
					@foreach($project_via_developer as $row)	
