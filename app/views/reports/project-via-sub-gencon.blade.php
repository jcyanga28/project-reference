...
<div class="row">
	...
	@if(isset($project_via_sub_gencon))
		@if(count($project_via_sub_gencon)>0)
		{{ Form::open(array('route' => 'generate.projectsviasubgencons.report', 'method' => 'POST','class' => 'bs-component')) }}
	...
	<table id="tbl_form_design" class="table table-striped">
		...
		<tbody>
			@if(isset($project_via_sub_gencon))
				@if(count($project_via_sub_gencon) > 0)
					@foreach($project_via_sub_gencon as $row)	
