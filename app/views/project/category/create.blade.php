...
@section('content')
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => 'project.category.store','class' => 'bs-component')) }}
		<div class="form-group @if ($errors->has('project_category')) has-error @endif">
			{{ Form::label('category_desc', 'Project Category') }}
			{{ Form::text('project_category','',array('class' => 'form-control', 'placeholder' => 'Project Category', 'id' => 'projects_input')) }}
