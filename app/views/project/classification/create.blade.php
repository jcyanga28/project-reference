...
@section('content')
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => 'project.classification.store','class' => 'bs-component')) }}
		<div class="form-group @if ($errors->has('project_classification')) has-error @endif">
			...
			{{ Form::text('project_classification','',array('class' => 'form-control', 'placeholder' => 'Project Classification', 'id' => 'projects_input')) }}
