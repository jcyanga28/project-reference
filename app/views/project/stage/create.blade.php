...
@section('content')
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => 'project.stage.store','class' => 'bs-component')) }}
		<div class="form-group @if ($errors->has('project_stage')) has-error @endif">
			{{ Form::label('stage_desc', 'Project Stage') }}
			{{ Form::text('project_stage','',array('class' => 'form-control', 'placeholder' => 'Project Stage', 'id' => 'projects_input')) }}
