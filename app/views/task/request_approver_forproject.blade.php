...
<li class="active"><a href="{{URL::route('task.request.approver.forproject')}}">PROJECT</a></li>
		...
		<div class="table-responsive">
			<table id="tbl_form_design" class="table table-striped table-hover">
				...
				@else	
					...
					@if($row->status < 3)	
						<td class="action">
							{{ HTML::linkRoute('task.approver.forproject.details','Details', $row->id, array('class' => 'btn btn-warning btn-xs')) }}
						</td>
					@endif
					</tr>
					@endforeach
