...
<div class="row">
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => 'task.forproject.store','class' => 'bs-component', 'files' => true)) }}
		<div class="form-group @if ($errors->has('company')) has-error @endif">
			{{ Form::label('project_desc', '*Project Name') }}
			<span>{{ Form::select('project', array('' => 'SELECT PROJECT NAME') + $get_project, null, array('class' => 'form-control project_input', 'id' => 'project_name')) }}</span>
