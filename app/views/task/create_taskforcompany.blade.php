...
<div class="row">
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => 'task.forcompany.store','class' => 'bs-component', 'files' => true)) }}
		<div class="form-group @if ($errors->has('company')) has-error @endif">
			{{ Form::label('company_desc', '*Company Name') }}
			<span>{{ Form::select('company', array('' => 'SELECT COMPANY NAME') + $get_company, null, array('class' => 'form-control company_input', 'id' => 'company_name')) }}</span>
