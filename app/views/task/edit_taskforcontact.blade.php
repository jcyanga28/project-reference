...
<div class="row">
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => array('task.forcontact.update', $get_taskforcontact->id), 'method' => 'PUT', 'class' => 'bs-component', 'files' => true)) }}
		<div class="form-group @if ($errors->has('contact')) has-error @endif">
			{{ Form::label('contact_desc', '*Contact Person') }}
			<span>{{ Form::select('contact', array($my_contact->id => $my_contact->fullname) + $get_contact, null, array('class' => 'form-control contact_input', 'id' => 'contact_person')) }}</span>
		...
		<div class="form-group @if ($errors->has('amount')) has-error @endif">
			...
			{{ Form::text('amount', $get_taskforcontact->amount,array('class' => 'form-control', 'placeholder' => '0.00', 'id' => 'amount_input')) }}
		...
		<div class="form-group">
			<div class="row">
			  <div class="col-lg-6">
				...
				<span>{{ Form::text('date_start', date("m-d-Y", strtotime($get_taskforcontact->date_start)), array('class' => 'form-control date_input', 'id' => 'daterange_start', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy')) }}</span>
			  ...
			  <div class="col-lg-6">	
			    ...
			    <span>{{ Form::text('date_end', date("m-d-Y", strtotime($get_taskforcontact->date_end)), array('class' => 'form-control date_input', 'id' => 'daterange_end', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy')) }}</span>
		...
		<div class="form-group @if ($errors->has('remarks')) has-error @endif">
			...
			{{ Form::textarea('remarks', strtoupper($get_taskforcontact->remarks), array('size' => '65x4', 'id' => 'remarks_input')) }}
