...
<div class="row">
	...
	@if($details->approved_request < 1)	
	 	 {{ Form::open(array('route' => 'task.forothers.approve','class' => 'bs-component', 'files' => true)) }} 				
	...
	@if($details->approved_request < 1)	
	 	 {{ Form::open(array('method' => 'PUT', 'route' => array('task.forothers.decline', $details->id))) }} 
	...
	@if($details->approved_request == 1)
		{{ Form::open(array('route' => 'task.forothers.approve.tagremarks','class' => 'bs-component', 'files' => true)) }} 				
