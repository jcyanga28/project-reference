...
<div class="row">
	...
	<div class="col-lg-6">
	{{ Form::open(array('route' => array('task.forproject.update', $get_taskforproject->id), 'method' => 'PUT', 'class' => 'bs-component', 'files' => true)) }}
		<div class="form-group @if ($errors->has('project')) has-error @endif">
			{{ Form::label('project_desc', '*Project Name') }}
			<span>{{ Form::select('project', array($my_project->id => $my_project->project_name) + $get_project, null, array('class' => 'form-control project_input', 'id' => 'project_name')) }}</span>
		...
		<div class="form-group @if ($errors->has('amount')) has-error @endif">
			...
			{{ Form::text('amount', $get_taskforproject->amount,array('class' => 'form-control', 'placeholder' => '0.00', 'id' => 'amount_input')) }}
		...
		<div class="form-group">
			<div class="row">
			  <div class="col-lg-6">
				...
				<span>{{ Form::text('date_start', date("m-d-Y", strtotime($get_taskforproject->date_start)), array('class' => 'form-control date_input', 'id' => 'daterange_start', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy')) }}</span>
			  ...
			  <div class="col-lg-6">	
			    ...
			    <span>{{ Form::text('date_end', date("m-d-Y", strtotime($get_taskforproject->date_end)), array('class' => 'form-control date_input', 'id' => 'daterange_end', 'data-date-format' => 'mm/dd/yyyy', 'placeholder' => 'mm/dd/yyyy')) }}</span>
		...
		<div class="form-group @if ($errors->has('remarks')) has-error @endif">
			...
			{{ Form::textarea('remarks', strtoupper($get_taskforproject->remarks), array('size' => '65x4', 'id' => 'remarks_input')) }}
		...
		<div class="form-group">
			...
			{{ HTML::linkRoute('create.mytask.project', 'Back', array(), array('class' => 'btn btn-default')) }}
		</div>
	{{ Form::close() }}
	</div>
</div>
