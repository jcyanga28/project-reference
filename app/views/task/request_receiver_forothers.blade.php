...
<li><a href="{{URL::route('task.request.receiver.forproject')}}">PROJECT</a></li>
<li class="active"><a href="{{URL::route('task.request.receiver.forothers')}}">OTHERS</a></li>
</ul>
			...
			<table id="tbl_form_design" class="table table-striped table-hover">
				...
				@else	
					...
					<tr>
						...
						<td class="action">
							{{ HTML::linkRoute('task.request.forothers.details','Details', $row->id, array('class' => 'btn btn-warning btn-xs')) }}
						</td>
					</tr>
					@endforeach
				@endif
