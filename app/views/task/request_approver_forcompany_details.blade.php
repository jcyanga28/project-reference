...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-6 col-md-12">
		...
		<tr>
			<td id="tbl_details_td">COMPANY</td><td>{{ strtoupper($details->company_name) }}</td>
		</tr>
		<tr>
	...
	<div>
		...
		@if(count($getattached)>0)	
			<table style="width: 50%; font-size: 12px;" class="table table-hover">
				<tr>
	...
	@if($details->approved_request == 1)
		{{ Form::open(array('route' => 'task.forcompany.approver.tagremarks','class' => 'bs-component', 'files' => true)) }} 				
