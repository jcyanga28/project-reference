...
<div class="row">
				 	 	...
				 	 	@if(isset($row->files))
					 	 	@foreach($row->files as $row_file)
					 	 		<tr>		
					 	 			...
					 	 			<td style="font-size: 12px;"><a href="/download-requestcontact-thread/{{ $row_file->filename }}">DOWNLOAD</a></td>
					 	 		</tr>	
					 	 	@endforeach
				 	 	@endif
				 	 	@if(isset($row->file))
					 	 	@foreach($row->file as $row_files)
					 	 		<tr>		
					 	 			...
					 	 			<td style="font-size: 12px;"><a href="/download-requestcontact-thread/{{ $row_files->filename }}">DOWNLOAD</a></td>
					 	 		</tr>	
					 	 	@endforeach
				 	 	@endif
				 	</table>
	...
	@if($details->approved_request == 1)
		{{ Form::open(array('route' => 'task.forcontact.approver.tagremarks','class' => 'bs-component', 'files' => true)) }} 				
