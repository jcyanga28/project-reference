...
<li class="active"><a href="{{URL::route('task.request.receiver.forcompany')}}">COMPANY</a></li>
			...
			<table id="tbl_form_design" class="table table-striped table-hover">
				...
				@else	
					...
					<tr>
						...
						<td class="action">
							{{ HTML::linkRoute('task.request.forcompany.details','Details', $row->id, array('class' => 'btn btn-warning btn-xs')) }}
						</td>
					</tr>
					@endforeach
				@endif
