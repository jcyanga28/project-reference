...
<div class="row">
	...
	@if($details->approved_request < 1)	
	 	 {{ Form::open(array('route' => 'task.forproject.approve','class' => 'bs-component', 'files' => true)) }} 				
	...
	@if($details->approved_request < 1)	
	 	 {{ Form::open(array('method' => 'PUT', 'route' => array('task.forproject.decline', $details->id))) }} 
	...
	@if($details->approved_request == 1)
		{{ Form::open(array('route' => 'task.forproject.approve.tagremarks','class' => 'bs-component', 'files' => true)) }} 				
